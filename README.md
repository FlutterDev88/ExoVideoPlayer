# ExoPlayerView
ExoPlayerView is based on [ExoPlayer](https://github.com/google/ExoPlayer).
...
## Using ExoPlayerView
### 1.Dependency
The easiest way to get started using ExoPlayerView is to add it as a gradle dependency. You need to make sure you have the JCenter and Google repositories included in the build.gradle file in the root of your project:
```
repositories {
    jcenter()
    google()
